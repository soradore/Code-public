...
$lang = array(
	...
	"chk_ext" => "PHPの拡張にsqliteが追加されているか確認してください",
	"autoincrement" => "自動増加",
	"not_null" => "Not NULL",
	"attention" => "Attention",
	"none" => "None",
	...
	"db_exists" => "'%s' という名前のデータベース、ディレクトリもしくはファイルは既に存在します",
	...
	"ques_del_db" => "データベース '%s' を本当に削除してよろしいですか?",
	...
	"chk_all" => "すべてチェック",
	"unchk_all" => "すべてチェックをはずす",
	"with_sel" => "With Selected",
	
	"no_tbl" => "データベース内にテーブルはありません",
	...
	"warn_passwd" => "デフォルトパスワードを使うのは危険です。パスワードは %s　を書き換えることで簡単に変更できます",
